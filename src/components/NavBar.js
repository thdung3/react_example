...
export default function NavBar(props) {
    ...
    return (
        <nav id="nav-bar" className="navbar navbar-expand-lg fixed-top" onScroll={(e) => changeColor(e)}>
            <a className="navbar-brand" href="#home" onClick={() => props.backHome()}>LAVIE MOVIE</a>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <ul className="navbar-nav mr-auto">
                    <li className="nav-item active">
                        <a className="nav-link" href="#home" onClick={() => props.backHome()}>Home <span className="sr-only">(current)</span></a>
                    </li>
                </ul>
                <div id="btn-search">
